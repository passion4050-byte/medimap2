    ...
    <section className="py-12 lg:py-16 px-4 sm:px-6 lg:px-8 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-10">
          ...
          <h2 className="bg-gradient-to-r from-blue-600 to-sky-600 bg-clip-text text-transparent mb-3" style={{ fontSize: 'clamp(28px, 5vw, 40px)', fontWeight: 900, letterSpacing: '-1px', lineHeight: 1.3 }}>
            제휴 파트너 특별 혜택
          </h2>
        ...
        <div className="hidden lg:grid grid-cols-1 lg:grid-cols-3 gap-5">
          {benefits.map((benefit, index) => {
            ...
            return (
              <div 
                key={index} 
                className="group bg-white rounded-2xl overflow-hidden border border-gray-100 hover:border-blue-200 hover:shadow-lg transition-all duration-500 hover:-translate-y-1"
              >
                {/* Image */}
        ...
        {/* Bottom CTA */}
        <div className="mt-10 text-center bg-gradient-to-r from-blue-600 to-sky-600 rounded-2xl p-8 shadow-lg">
          ...
          <button 
            ...
            className="px-8 py-3.5 bg-white text-blue-600 rounded-full hover:shadow-xl transition-all inline-flex items-center gap-2 hover:scale-105" 
