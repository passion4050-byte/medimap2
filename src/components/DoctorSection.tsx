...
export function DoctorSection() {
  ...
  return (
    <section className="py-16 lg:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white via-blue-50/40 to-sky-50/40 relative overflow-hidden" id="doctors">
      {/* Background Elements */}
      <div className="absolute top-10 left-0 w-80 h-80 bg-blue-200/20 rounded-full blur-3xl"></div>
      <div className="absolute bottom-10 right-0 w-80 h-80 bg-sky-200/20 rounded-full blur-3xl"></div>
      
      <div className="max-w-7xl mx-auto relative z-10">
        {/* Header */}
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2.5 px-5 py-3 bg-white border-2 border-blue-200/60 rounded-full mb-5 shadow-xl">
            <Users className="w-4.5 h-4.5 text-blue-600" />
            <span className="text-blue-600" style={{ fontSize: '13px', fontWeight: 800, letterSpacing: '0.5px' }}>
              MEDICAL TEAM
            </span>
          </div>
          
          <h2 className="bg-gradient-to-r from-blue-600 to-sky-600 bg-clip-text text-transparent mb-4" style={{ fontSize: 'clamp(28px, 5vw, 40px)', fontWeight: 900, letterSpacing: '-1.5px', lineHeight: 1.2 }}>
            최고의 전문 의료진
          </h2>
            ...
            >
              ...
              <div className="p-5">
                ...
                <div className="grid grid-cols-2 gap-3 mb-4">
                  ...
                  <div className="text-center p-3 bg-gradient-to-br from-sky-50 to-cyan-50 rounded-lg">
                    <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center mx-auto mb-1.5 shadow-sm">
                      <Heart className="w-4 h-4 text-sky-600" />
                    </div>
                    <p className="text-sky-600 mb-0.5" style={{ fontSize: '16px', fontWeight: 900 }}>
                      {doctor.patients}
                    </p>
                    <p className="text-gray-600" style={{ fontSize: '11px', fontWeight: 700 }}>
                      시술
                  ...
                  <div className="bg-white rounded-3xl overflow-hidden border-2 border-gray-100/60 shadow-md">
                    ...
                    <div className="p-5">
                      ...
                      <div className="grid grid-cols-2 gap-3 mb-4">
                        ...
                        <div className="text-center p-2.5 bg-gradient-to-br from-sky-50 to-cyan-50 rounded-lg">
                          <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center mx-auto mb-1 shadow-sm">
                            <Heart className="w-4 h-4 text-sky-600" />
                          </div>
                          <p className="text-sky-600 mb-0.5" style={{ fontSize: '15px', fontWeight: 900, lineHeight: 1.2 }}>
                            {doctor.patients}
                          </p>
                          <p className="text-gray-600" style={{ fontSize: '10px', fontWeight: 700, lineHeight: 1.3 }}>
                            시술
