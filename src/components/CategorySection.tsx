...
export function CategorySection({ onNavigate }: CategorySectionProps) {
  ...
  return (
    <section className="py-16 lg:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-sky-50/40 via-white to-blue-50/40 relative overflow-hidden" id="categories">
      
      <div className="max-w-7xl mx-auto relative z-10">
        {/* Header - Mobile Optimized */}
        <div className="text-center mb-10 sm:mb-12">
          <div className="inline-flex items-center gap-2 sm:gap-2.5 px-4 sm:px-5 py-2.5 sm:py-3 bg-white border-2 border-blue-200/60 rounded-full mb-4 sm:mb-5 shadow-lg">
            <TrendingDown className="w-4 h-4 sm:w-4.5 sm:h-4.5 text-blue-600" />
            <span className="text-blue-600" style={{ fontSize: 'clamp(11px, 2.8vw, 13px)', fontWeight: 800, letterSpacing: '0.5px' }}>
              MEDICAL SPECIALTIES
            </span>
          </div>
          
          <h2 className="bg-gradient-to-r from-blue-600 to-sky-600 bg-clip-text text-transparent mb-3 sm:mb-4 px-4" style={{ fontSize: 'clamp(26px, 5.5vw, 40px)', fontWeight: 900, letterSpacing: '-1.5px', lineHeight: 1.25 }}>
            전문 진료 분야
          </h2>
        ...
        <div className="flex justify-center mb-10 sm:mb-12 px-4">
          <div className="inline-flex p-1.5 sm:p-2 bg-white border-2 border-blue-100/60 rounded-xl sm:rounded-2xl gap-1.5 sm:gap-2 shadow-xl max-w-full overflow-x-auto">
              ...
              return (
                <button
                  ...
                  className={`
                    ...
                    ${isActive 
                      ? 'bg-gradient-to-r from-blue-600 via-blue-500 to-sky-600 text-white shadow-lg shadow-blue-500/30 scale-105' 
        ...
        {activeCategory && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
            ...
            <div className="hidden lg:block order-2 lg:order-1">
              <div className="relative rounded-3xl overflow-hidden border-2 border-blue-100/60 shadow-xl">
                ...
                <div className="absolute top-5 left-5">
                  <div className="px-5 py-3 bg-white/98 backdrop-blur-sm rounded-2xl shadow-xl border-2 border-blue-200/60">
                    <div className="flex items-center gap-2">
                      <Sparkles className="w-5 h-5 text-blue-600" />
                      <span className="text-blue-600" style={{ fontSize: '18px', fontWeight: 900 }}>
            ...
            <div className="order-1 lg:order-2">
              {/* Icon Badge */}
              <div className={`w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br ${activeCategory.color} rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-5 shadow-xl shadow-blue-500/25`}>
                {(() => {
              ...
              <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-7 px-4 sm:px-0">
                <p className="text-blue-600" style={{ fontSize: 'clamp(11px, 2.8vw, 13px)', fontWeight: 800, letterSpacing: '0.8px', textTransform: 'uppercase' }}>
                  주요 진료 항목
                </p>
                
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 sm:gap-3">
                  {activeCategory.treatments.map((treatment, idx) => (
                    <div key={idx} className="flex items-center gap-2.5 sm:gap-3 p-3 sm:p-4 bg-white rounded-lg sm:rounded-xl border-2 border-blue-100/60 hover:border-blue-300 active:border-blue-300 hover:shadow-lg active:shadow-lg transition-all">
