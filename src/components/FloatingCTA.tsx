    ...
    <>
      ...
      <div className="hidden lg:flex fixed bottom-6 right-6 lg:bottom-8 lg:right-8 flex-col gap-3 z-50">
        ...
        {showScrollTop && (
          <button
            onClick={scrollToTop}
            className="w-14 h-14 lg:w-16 lg:h-16 bg-white text-blue-600 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center border border-blue-100 hover:scale-110 group"
            aria-label="맨 위로"
          >
      ...
      {/* Mobile Bottom Bar */}
      <div className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-xl border-t border-blue-100 px-4 py-3 safe-area-bottom" style={{ boxShadow: '0 -4px 20px rgba(0, 102, 255, 0.1)' }}>
        <a
          href="https://pf.kakao.com/_xnWQkG/chat"
          target="_blank"
          rel="noopener noreferrer"
