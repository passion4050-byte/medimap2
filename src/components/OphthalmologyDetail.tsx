          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <a href="https://pf.kakao.com/_xnWQkG/chat" target="_blank" rel="noopener noreferrer" className="px-7 py-4 bg-white text-gray-800 rounded-2xl border-2 border-yellow-400 hover:bg-yellow-50 hover:shadow-md hover:shadow-yellow-400/20 transition-all hover:scale-[1.02] flex items-center justify-center gap-2.5" style={{ fontSize: '15px', fontWeight: 700 }}>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-12 max-w-5xl mx-auto">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl">
              <ImageWithFallback
                src="https://cdn.imweb.me/upload/S202302154d48be455c812/60aad6e4d3d1e.jpg"
                alt="시술 과정 안내"
