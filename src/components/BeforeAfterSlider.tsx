      ...
      >
        ...
        <div className="flex-shrink-0 w-full pl-4">
          <div className="bg-gradient-to-br from-blue-50 to-sky-50 rounded-2xl p-4 border border-blue-100">
            <div className="relative">
              <div className="absolute top-3 left-1/2 -translate-x-1/2 z-10">
                <span className="inline-block px-2.5 py-1 bg-gradient-to-r from-blue-600 to-sky-600 text-white rounded-full shadow-sm" style={{ fontSize: '10px', fontWeight: 600, letterSpacing: '0.5px' }}>
                  AFTER
                </span>
              </div>
              <img
...
export function BeforeAfterSlider() {
  ...
  return (
    <section className="py-12 lg:py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-blue-50/30 via-white to-sky-50/30 relative overflow-hidden">
      {/* Background Elements */}
      <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-blue-200/20 to-sky-200/20 rounded-full blur-3xl"></div>
      <div className="absolute bottom-0 left-0 w-64 h-64 bg-gradient-to-br from-cyan-200/20 to-blue-200/20 rounded-full blur-3xl"></div>
      
      <div className="max-w-6xl mx-auto relative z-10">
        {/* Header */}
        <div className="text-center mb-10">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-blue-100 rounded-full mb-4 shadow-md">
          ...
          <p className="text-gray-700 max-w-xl mx-auto px-4" style={{ fontSize: 'clamp(13.5px, 3.5vw, 16px)', fontWeight: 500, lineHeight: 1.8 }}>
            MEDIMAP의 <strong style={{ fontWeight: 700 }}>정밀한 진단과 시술</strong>로<br className="sm:hidden" /> 변화된<br className="hidden sm:block" />
        ...
        <div className="max-w-5xl mx-auto">
          <div className="relative">
                  ...
                  <div key={index} className="w-full flex-shrink-0">
                    ...
                    <div className="hidden md:grid grid-cols-2 gap-6 px-2">
                      ...
                      <div className="bg-gradient-to-br from-blue-50 to-sky-50 rounded-3xl p-6 border border-blue-100">
                        <div className="relative">
                          <div className="absolute top-4 left-1/2 -translate-x-1/2 z-10">
                            <span className="inline-block px-3 py-1.5 bg-gradient-to-r from-blue-600 to-sky-600 text-white rounded-full shadow-sm" style={{ fontSize: '11px', fontWeight: 600, letterSpacing: '0.5px' }}>
                              AFTER
                            </span>
                          </div>
                          <img
                    ...
                    <div className="mt-6 p-4 md:p-6 bg-gradient-to-r from-blue-600 to-sky-600 rounded-2xl md:rounded-3xl text-white text-center mx-2">
            ...
            <div className="flex items-center justify-center gap-4 mt-8">
              ...
              <button
                onClick={prevSlide}
                className="w-12 h-12 bg-white rounded-full shadow-lg hover:shadow-xl transition-all flex items-center justify-center group hover:scale-110 border-2 border-blue-100"
                aria-label="이전"
              >
                <ChevronLeft className="w-6 h-6 text-blue-600 group-hover:text-sky-600 transition-colors" />
              </button>
                ...
                {beforeAfterData.map((_, index) => (
                  <button
                    ...
                    className={`h-3 rounded-full transition-all ${
                      currentSlide === index
                        ? 'w-8 bg-gradient-to-r from-blue-600 to-sky-600'
              ...
              <button
                ...
                aria-label="다음"
              >
                <ChevronRight className="w-6 h-6 text-blue-600 group-hover:text-sky-600 transition-colors" />
              </button>
            </div>
          </div>
