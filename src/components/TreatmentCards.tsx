      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="hidden lg:grid lg:grid-cols-2 gap-6 mb-8">
          {treatments.map((treatment, index) => {
            ...
            return (
              <div 
                key={index}
                className="group bg-white rounded-3xl overflow-hidden border border-gray-100/50 hover:border-blue-200 hover:shadow-xl transition-all duration-500 hover:-translate-y-2"
              >
                {/* Image */}
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between pt-5 border-t border-gray-100/50 mb-5">
                    <div>
                      ...
                      <div className="flex items-baseline gap-2">
                        <p className="text-blue-600" style={{ fontSize: '22px', fontWeight: 900, letterSpacing: '-0.5px' }}>
                          {treatment.price}
                        </p>
                      </div>
                    </div>
                    <div className="px-3.5 py-2 bg-gradient-to-r from-blue-50 to-sky-50 border border-blue-200 rounded-xl">
                      <span className="text-blue-600" style={{ fontSize: '12px', fontWeight: 800 }}>
                        제휴가
                      </span>
                    </div>
                  </div>
                  ...
                  <button 
                    ...
                    className={`w-full py-3.5 bg-gradient-to-r ${treatment.color} text-white rounded-2xl hover:shadow-lg hover:shadow-blue-500/25 transition-all duration-300 group/btn flex items-center justify-center gap-2 hover:scale-[1.02]`} 
                  ...
                  <div key={index} className="min-w-full px-1">
                    <div className="bg-white rounded-3xl overflow-hidden border border-gray-100 shadow-md">
                      ...
                      <div className="relative h-48">
                        ...
                        <button
                          onClick={prevSlide}
                          className="absolute left-2 top-1/2 -translate-y-1/2 w-8 h-8 bg-white/90 backdrop-blur-sm rounded-full shadow-lg flex items-center justify-center text-blue-600 active:scale-95 transition-transform z-10"
                        >
                          <ChevronLeft className="w-5 h-5" />
                        </button>
                        <button
                          onClick={nextSlide}
                          className="absolute right-2 top-1/2 -translate-y-1/2 w-8 h-8 bg-white/90 backdrop-blur-sm rounded-full shadow-lg flex items-center justify-center text-blue-600 active:scale-95 transition-transform z-10"
                        >
                      ...
                      <div className="p-5">
                        ...
                        <div className="grid grid-cols-2 gap-2 mb-4">
                          {treatment.features.map((feature, idx) => (
                            <div key={idx} className="flex items-center gap-1.5">
                              <div className="w-3.5 h-3.5 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0">
                        ...
                        <div className="flex items-center justify-between pt-4 border-t border-gray-100 mb-4">
                          <div>
                            ...
                            <p className="text-blue-600" style={{ fontSize: '17px', fontWeight: 900, lineHeight: 1.2 }}>
                              {treatment.price}
                            </p>
                          </div>
                        </div>
            ...
            {treatments.map((_, index) => (
              <button
                ...
                className={`h-2 rounded-full transition-all ${
                  currentSlide === index ? 'w-8 bg-gradient-to-r from-blue-600 to-sky-600' : 'w-2 bg-gray-300'
                }`}
              />
            ))}
          </div>
        ...
        <div className="mt-12 grid grid-cols-3 gap-4">
          {[
            ...
            return (
              <div key={idx} className="text-center p-5 bg-gradient-to-br from-blue-50 to-sky-50 rounded-2xl border border-blue-100/50">
                <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-sky-500 rounded-xl flex items-center justify-center mx-auto mb-3 shadow-md">
                  <Icon className="w-5 h-5 text-white" />
                </div>
                <p className="text-blue-600 mb-1" style={{ fontSize: 'clamp(20px, 4vw, 24px)', fontWeight: 900 }}>
                  {stat.number}
                </p>
